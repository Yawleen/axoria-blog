...
import { HOME_ROUTE, CATEGORIES_ROUTE, DASHBOARD_CREATE_ROUTE, SIGN_UP_ROUTE, SIGN_IN_ROUTE } from "@/config/routes"
    ...
    return (
        <nav className="fixed w-full bg-slate-50 border-b border-b-zinc-300">
            <div className="u-main-container flex py-4">
                ...
                <Link href={SIGN_UP_ROUTE} className="text-zinc-900">S'inscrire</Link>
                <Link href={SIGN_IN_ROUTE} className="text-zinc-900 mr-2">Se connecter</Link>
            </div>
        </nav>
    )
}